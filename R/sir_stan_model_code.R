sir_stan_model_code = function( selection="default"  ) {
  ...
  if ( selection %in% c( "default",   "discrete_autoregressive_structured_beta_mortality_gaussian") ) {
...
"
  ...
  if ( selection %in% c(   "discrete_autoregressive_structured_beta_mortality_poisson") ) {
...
############
  ...
  if ( selection %in% c( "discrete_autoregressive_structured_beta_mortality_binomial") ) {
